...
2.  $env:INPUT_TOKEN="Basic bzdnRXJ4RlVrZkl5VjFVU3l6dExTSA=="    - add the token to the env for test
3.  $env:INPUT_DAYS="7"                                          - add the day to the env for test
4.  $env:INPUT_FOLDER="C:\Test"                                  - add the folder to the env for test
5.  $env:INPUT_AUTH="true"                                       - add the auth to the env for test
6.  $env:INPUT_PRIVATE="0"                                       - add the privat to the env for test
7.  $env:INPUT_POOL="avitest"                                    - add the pool to the env for test
8.  $env:INPUT_EMAIL="avih75@gmail.com"                          - add the client mail to the env for test
9.  $env:INPUT_SUBJECT="Subject is"                              - add the Subject of the email to the env for test
10. $env:INPUT_BODY="Body is"                                    - add the body of the email to the env for test
11. $env:INPUT_GROUP="true"                                      - add the group of the email to the env for test
11. $env:INPUT_DELL="false"                                      - add the delete 
