...
export class LiquidFileUploader {
    ...
    private readonly InputEmail: string;
    ...
    constructor(inputUrl: string | undefined, inputToken: string | undefined, inputDays: string | undefined,
        ...
        inputEmail: string | undefined, inputSubject: string | undefined, inputBody: string | undefined, inputAuth: boolean) {
    ...
    PostTheFile(fileBuffer: Buffer, fileName: string, url: string, token: string, pool: string, email: string, days: number, privFile: String, subject: string, body: string) {
